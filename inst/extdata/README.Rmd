...
knitr::include_graphics(system.file("extdata", "www/upload-data.png", package ="SeuratExplorer"), rel_path = FALSE)
```
...
```{r  echo = FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics(system.file("extdata", "www/cell-metadata.jpg", package ="SeuratExplorer"), rel_path = FALSE)
```
...
knitr::include_graphics(system.file("extdata", "www/Dimplot-splited.png", package ="SeuratExplorer"), rel_path = FALSE)
```
...
knitr::include_graphics(system.file("extdata", "www/Featureplot.png", package ="SeuratExplorer"), rel_path = FALSE)
knitr::include_graphics(system.file("extdata", "www/Featureplot-splited.png", package ="SeuratExplorer"), rel_path = FALSE)
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics(system.file("extdata", "www/ViolinPlot.png", package ="SeuratExplorer"), rel_path = FALSE)
knitr::include_graphics(system.file("extdata", "www/ViolinPlot-Stack.png", package ="SeuratExplorer"), rel_path = FALSE)
knitr::include_graphics(system.file("extdata", "www/ViolinPlot-splited.png", package ="SeuratExplorer"), rel_path = FALSE)
knitr::include_graphics(system.file("extdata", "www/ViolinPlot-splited-Stack.png", package ="SeuratExplorer"), rel_path = FALSE)
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics(system.file("extdata", "www/DotPlot.png", package ="SeuratExplorer"), rel_path = FALSE)
knitr::include_graphics(system.file("extdata", "www/DotPlot-Splited.png", package ="SeuratExplorer"), rel_path = FALSE)
```
...
```{r echo = FALSE}
knitr::include_graphics(system.file("extdata", "www/Heatmap-CellLevel.png", package ="SeuratExplorer"), rel_path = FALSE)
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics(system.file("extdata", "www/Heatmap-GroupLevel.png", package ="SeuratExplorer"), rel_path = FALSE)
knitr::include_graphics(system.file("extdata", "www/Heatmap-GroupLevel-2.png", package ="SeuratExplorer"), rel_path = FALSE)
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics(system.file("extdata", "www/RidgePlot.png", package ="SeuratExplorer"), rel_path = FALSE)
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics(system.file("extdata", "www/CellRatio.png", package ="SeuratExplorer"), rel_path = FALSE)
knitr::include_graphics(system.file("extdata", "www/CellRatio-Splited.png", package ="SeuratExplorer"), rel_path = FALSE)
```
...
```{r echo = FALSE, out.width="50%"}
knitr::include_graphics(system.file("extdata", "www/DEGs-1.png", package ="SeuratExplorer"), rel_path = FALSE)
knitr::include_graphics(system.file("extdata", "www/DEGs-2.png", package ="SeuratExplorer"), rel_path = FALSE)
```

#### Output description

```{r echo = FALSE}
knitr::include_graphics(system.file("extdata", "www/DEGs-4.jpg", package ="SeuratExplorer"), rel_path = FALSE)
```
...
```{r echo = FALSE, out.width="80%"}
knitr::include_graphics(system.file("extdata", "www/Find-Top-Genes-by-Cell.jpg", package ="SeuratExplorer"), rel_path = FALSE)
```
...
```{r echo = FALSE, out.width="80%"}
knitr::include_graphics(system.file("extdata", "www/Find-Top-Genes-by-Mean-UMI-counts.jpg", package ="SeuratExplorer"), rel_path = FALSE)
```
...
```{r echo = FALSE, out.width="80%"}
knitr::include_graphics(system.file("extdata", "www/gene-short-summary.jpg", package ="SeuratExplorer"), rel_path = FALSE)
```
...
```{r echo = FALSE}
knitr::include_graphics(system.file("extdata", "www/featurecorrelation.jpg", package ="SeuratExplorer"), rel_path = FALSE)
```

#### Output description

```{r echo = FALSE, out.width="40%"}
knitr::include_graphics(system.file("extdata", "www/feature-correlation-output.jpg", package ="SeuratExplorer"), rel_path = FALSE)
```
